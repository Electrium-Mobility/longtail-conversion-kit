...
typedef struct {
	...
	// GPDrive
	int32_t gpd_buffer_notify_left;
	int32_t gpd_buffer_interpol;
...
typedef struct {
	...
	float rpm;
	int32_t tacho;
	int32_t cycles_running;
	int32_t tim_val_samp;
	int32_t tim_current_samp;
	int32_t tim_top;
	int32_t comm_step;
	float temperature;
	int32_t drv8301_faults;
} fault_data;
